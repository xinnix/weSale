  ...
  <view class="agreement-container">
    <view class="content">
      ...
      <view class="section">
        ...
        <text class="paragraph">
          1.2
          您通过网络页面点击确认或以其他方式选择接受本协议，即表示您与我们已达成协议并同意接受本协议的全部约定内容。
        </text>
        <text class="paragraph">
          1.3 我们有权在必要时修改本协议条款，您可以在相关服务页面查阅最新版本的协议条款。
        </text>
      </view>
      ...
      <view class="section">
        ...
        <text class="paragraph">
          2.2 您应当对账号的安全负责，因您保管不当可能造成的账号被盗、密码泄露等后果，由您自行承担。
        </text>
        <text class="paragraph">
          2.3
          您不得将账号转让、出借、出租给他人使用，因账号转让、出借、出租给他人使用所产生的一切后果，由您自行承担。
        </text>
      </view>
      ...
      <view class="section">
        ...
        <text class="paragraph">
          4.3 因系统维护、升级等原因，我们可能暂停部分服务，我们会尽可能提前通知。
        </text>
      </view>
      ...
      <view class="section">
        ...
        <text class="paragraph">
          5.2 未经我们书面许可，您不得复制、转载、引用、链接、抓取或以其他方式使用本平台的内容。
        </text>
      </view>
      ...
      <view class="section">
        ...
        <text class="paragraph">
          6.2 因不可抗力或其他我们无法控制的原因造成的服务中断或终止，我们不承担责任。
        </text>
      </view>
      ...
      <view class="section">
        ...
        <text class="paragraph">
          8.2
          如就本协议内容或其执行发生任何争议，双方应尽力友好协商解决；协商不成时，任何一方均可向我们所在地有管辖权的人民法院提起诉讼。
        </text>
      </view>
