    ...
    <view class="content">
      ...
      <view class="intro">
        <text class="intro-text">
          我们深知个人信息对您的重要性，您的信赖对我们非常重要，我们将按照法律法规要求，采取相应安全保护措施，尽力保护您的个人信息安全可控。
        </text>
        <text class="intro-text">
          鉴于此，我们制定本隐私政策并以明确的方式向您展示，请您在使用我们提供的各项服务前，仔细阅读并充分理解本隐私政策。
        </text>
      </view>
      ...
      <view class="section">
        ...
        <text class="paragraph">
          1.1
          账号注册信息：您通过微信授权登录时，我们会获取您的微信OpenID、昵称、头像等基本信息。
        </text>
        <text class="paragraph">
          1.2 手机号码：为了提供更完整的服务，我们可能需要您授权获取手机号码。
        </text>
        <text class="paragraph">
          1.3 交易信息：您领取优惠券、核销优惠券等操作产生的记录信息。
        </text>
        <text class="paragraph">
          1.4
          设备信息：我们会收集您的设备型号、操作系统版本、设备标识符等信息，用于优化服务体验。
        </text>
      </view>
      ...
      <view class="section">
        ...
        <text class="paragraph">
          3.2
          信息保护：我们采取业界领先的技术保护措施，包括但不限于数据加密、访问控制、安全审计等，保护您的个人信息安全。
        </text>
        <text class="paragraph">
          3.3
          安全事件处置：若不幸发生个人信息安全事件，我们将按照法律法规要求，及时向您告知安全事件的基本情况、可能影响、已采取或将要采取的处置措施等。
        </text>
      </view>
      ...
      <view class="section">
        ...
        <text class="paragraph">
          6.2
          如您为未成年人，请在监护人指导下阅读本政策，并在取得监护人同意后使用我们的服务。
        </text>
        <text class="paragraph">
          6.3
          如您的监护人不同意您使用我们的服务或向我们提供信息，请您立即终止使用我们的服务并及时通知我们。
        </text>
      </view>
      ...
      <view class="section">
        ...
        <text class="paragraph">
          7.3
          对于重大变更，我们还会提供更为显著的通知形式，如您继续使用我们的服务，即表示您同意接受修订后的政策。
        </text>
      </view>
