...
```bash
node .Codex/skills/deleteModule/delete-module.ts <moduleName>
```
...
node .Codex/skills/deleteModule/delete-module.ts product --dry-run

# 强制删除（不确认）
node .Codex/skills/deleteModule/delete-module.ts product --force
```
...
```bash
# 删除 product 模块
node .Codex/skills/deleteModule/delete-module.ts product
